 ...
 * If found, the program will display table giving the user with ID, student name and the grade of the student.
 * 
...
public class CalculateGrade extends Application {
    ...
    public static boolean calcGradeNotifier;
    ...
    public void start(Stage primaryStage) {
        ...
        //creating a button 
        Button showResultButton = new Button("Calculate Grade Result");

        //creating a vertical box named containers that holds the data
        VBox containers = new VBox();
        VBox discriptorHolder = new VBox();
        Label discriptor = new Label(
                "User can input the appropriate ID. \nBased on the ID, the option will calculate the grade\n\n");
        ...
        //setting up the action listener. When this button is pressed, it calls the showResult button method.
        showResultButton.setOnAction(e -> showResult());

        // Create a scene and place it in the stage
        vBox.getChildren().addAll(containers, lblStatus);
        primaryStage.setTitle("Calculate Grade"); // Set the stage title
        ...
        if (stringInputValue.matches("[0-99999999]+") == false | stringInputValue.length() != 8) {
            ...
            try {
                ...
                if(dataFromDatabase == null){
                    ...
                    TableDataView1.calcGrade(dataFromDatabase);
                    
                }
                

                // TableDataView1 tableDataView = new TableDataView1(dataFromDatabase);
